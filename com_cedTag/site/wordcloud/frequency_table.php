...
class FrequencyTable
{
    ...
    //TODO reuse stopwords not use since tags are already filtered out in cedTag
    ...
    public function add_word($word, $nbr_occurence = 1, $title = null, $link = '')
    {
        $this->insert_word($word, $nbr_occurence, $title, $link);
    }
    ...
    private function insert_word($word, $count = 1, $title = null, $link = '', $reject = false, $cleanup = false)
    {
